...
public class PredefMacros {
	...
	public static final Atom spATbreve_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		VRowAtom vra = new VRowAtom(
				new TeXFormula("\\displaystyle\\!\\breve{}").root);
	...
	public static final Atom spAThat_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		VRowAtom vra = new VRowAtom(
				new TeXFormula("\\displaystyle\\widehat{}").root);
		vra.setRaise(TeXConstants.UNIT_EX, 0.6f);
	...
	public static final Atom hvspace_macro(final TeXParser tp,
		...
		return args[0].charAt(0) == 'h' ? new SpaceAtom(unit, f, 0, 0)
				: new SpaceAtom(unit, 0, f, 0);
	}

	public static final Atom clrlap_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new LapedAtom(new TeXFormula(tp, args[1]).root,
				args[0].charAt(0));
	}
	...
	public static final Atom rule_macro(final TeXParser tp, final String[] args)
		...
		return new RuleAtom((int) winfo[0], winfo[1], (int) hinfo[0], hinfo[1],
				(int) rinfo[0], -rinfo[1]);
	}
	...
	public static final Atom cfrac_macro(final TeXParser tp, final String[] args)
		...
		Atom f = new FractionAtom(num.root, denom.root, true, alig,
	...
	public static final Atom sfrac_macro(final TeXParser tp, final String[] args)
		...
		if (!tp.isMathMode()) {
			...
			shiftL = -0.24f;
			shiftR = -0.24f;
			slash = new VRowAtom(new ScaleAtom(
	...
	public static final Atom genfrac_macro(final TeXParser tp,
		...
		if (num.root == null || denom.root == null)
			throw new ParseException(
					"Both numerator and denominator of a fraction can't be empty!");
		Atom at = new FractionAtom(num.root, denom.root, rule, (int) ths[0],
				ths[1]);
		RowAtom rat = new RowAtom();
	...
	public static final Atom overwithdelims_macro(final TeXParser tp,
		...
		if (left instanceof SymbolAtom && right instanceof SymbolAtom) {
			return new FencedAtom(new FractionAtom(num, denom, true),
	...
	public static final Atom abovewithdelims_macro(final TeXParser tp,
		...
		if (right instanceof BigDelimiterAtom)
			right = ((BigDelimiterAtom) right).delim;
		if (left instanceof SymbolAtom && right instanceof SymbolAtom) {
			return new FencedAtom(new FractionAtom(num, denom, (int) dim[0],
	...
	public static final Atom mbox_macro(final TeXParser tp, final String[] args)
			throws ParseException {
		Atom group = new RomanAtom(new TeXFormula(tp, args[1], "mathnormal",
				false, false).root);
	...
	public static final Atom text_macro(final TeXParser tp, final String[] args)
			throws ParseException {
		return new RomanAtom(new TeXFormula(tp, args[1], "mathnormal", false,
				false).root);
	}
	...
	public static final Atom accent_macros(final TeXParser tp,
			final String[] args) throws ParseException {
		return new AccentedAtom(new TeXFormula(tp, args[1], false).root,
				args[0]);
	}
	...
	public static final Atom sqrt_macro(final TeXParser tp, final String[] args)
		...
		return new NthRoot(new TeXFormula(tp, args[1], false).root,
				new TeXFormula(tp, args[2], false).root);
	}

	public static final Atom overrightarrow_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new UnderOverArrowAtom(new TeXFormula(tp, args[1], false).root,
				false, true);
	}
	...
	public static final Atom underbrace_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new OverUnderDelimiter(new TeXFormula(tp, args[1], false).root,
	...
	public static final Atom mathop_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		TypedAtom at = new TypedAtom(TeXConstants.TYPE_BIG_OPERATOR,
				TeXConstants.TYPE_BIG_OPERATOR, new TeXFormula(tp, args[1],
						false).root);
	...
	public static final Atom mathpunct_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new TypedAtom(TeXConstants.TYPE_PUNCTUATION,
				TeXConstants.TYPE_PUNCTUATION, new TeXFormula(tp, args[1],
						false).root);
	}
	...
	public static final Atom mathord_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new TypedAtom(TeXConstants.TYPE_ORDINARY,
				TeXConstants.TYPE_ORDINARY,
				new TeXFormula(tp, args[1], false).root);
	}

	public static final Atom mathrel_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new TypedAtom(TeXConstants.TYPE_RELATION,
	...
	public static final Atom mathinner_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new TypedAtom(TeXConstants.TYPE_INNER, TeXConstants.TYPE_INNER,
				new TeXFormula(tp, args[1], false).root);
	}

	public static final Atom mathbin_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new TypedAtom(TeXConstants.TYPE_BINARY_OPERATOR,
				TeXConstants.TYPE_BINARY_OPERATOR, new TeXFormula(tp, args[1],
						false).root);
	}

	public static final Atom mathopen_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new TypedAtom(TeXConstants.TYPE_OPENING,
	...
	public static final Atom mathclose_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new TypedAtom(TeXConstants.TYPE_CLOSING,
	...
	public static final Atom joinrel_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new TypedAtom(TeXConstants.TYPE_RELATION,
				TeXConstants.TYPE_RELATION, new SpaceAtom(TeXConstants.UNIT_MU,
						-2.6f, 0, 0));
	}
	...
	public static final Atom left_macro(final TeXParser tp, final String[] args)
		...
		if (left instanceof SymbolAtom && right instanceof SymbolAtom) {
			...
			return new FencedAtom(tf.root, (SymbolAtom) left, tf.middle,
					(SymbolAtom) right);
		}
	...
	public static final Atom leftparenthesis_macro(final TeXParser tp,
		...
		return new MathAtom(new TeXFormula(tp, grp, false).root,
	...
	public static final Atom intertext_macro(final TeXParser tp,
		...
		Atom at = new RomanAtom(new TeXFormula(tp, str, "mathnormal", false,
				false).root);
	...
	public static final Atom multicolumn_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		int n = Integer.parseInt(args[1]);
		tp.addAtom(new MulticolumnAtom(n, args[2],
				new TeXFormula(tp, args[3]).root));
	...
	public static final Atom stackrel_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		Atom at = new UnderOverAtom(new TeXFormula(tp, args[2], false).root,
				new TeXFormula(tp, args[3], false).root, TeXConstants.UNIT_MU,
				0.5f, true, new TeXFormula(tp, args[1], false).root,
	...
	public static final Atom overset_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		Atom at = new UnderOverAtom(new TeXFormula(tp, args[2], false).root,
				new TeXFormula(tp, args[1], false).root, TeXConstants.UNIT_MU,
				2.5f, true, true);
		return new TypedAtom(TeXConstants.TYPE_RELATION,
				TeXConstants.TYPE_RELATION, at);
	}
	...
	public static final Atom undertilde_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		Atom at = new TeXFormula(tp, args[1], false).root;
		return new UnderOverAtom(at, new AccentedAtom(new PhantomAtom(at, true,
	...
	public static final Atom rm_macro(final TeXParser tp, final String[] args)
			throws ParseException {
		return new RomanAtom(new TeXFormula(tp, tp.getOverArgument(), null,
				false, tp.isIgnoreWhiteSpace()).root);
	}

	public static final Atom mathbf_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new BoldAtom(new RomanAtom(
				new TeXFormula(tp, args[1], false).root));
	}
	...
	public static final Atom bf_macro(final TeXParser tp, final String[] args)
			throws ParseException {
		return new BoldAtom(new RomanAtom(
				new TeXFormula(tp, tp.getOverArgument(), null, false,
	...
	public static final Atom tt_macro(final TeXParser tp, final String[] args)
			throws ParseException {
		return new TtAtom(new TeXFormula(tp, tp.getOverArgument(), null, false,
				tp.isIgnoreWhiteSpace()).root);
	}
	...
	public static final Atom it_macro(final TeXParser tp, final String[] args)
			throws ParseException {
		return new ItAtom(new TeXFormula(tp, tp.getOverArgument(), null, false,
				tp.isIgnoreWhiteSpace()).root);
	}
	...
	public static final Atom sf_macro(final TeXParser tp, final String[] args)
			throws ParseException {
		return new SsAtom(new TeXFormula(tp, tp.getOverArgument(), null, false,
				tp.isIgnoreWhiteSpace()).root);
	}
	...
	public static final Atom GeoGebra_macro(final TeXParser tp,
		...
		tf.add("\\mathsf{Gebra}");
		return new ColorAtom(tf.root, null, Color.argb(255, 102, 102, 102));
	}

	public static final Atom hphantom_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new PhantomAtom(new TeXFormula(tp, args[1], false).root, true,
				false, false);
	}

	public static final Atom vphantom_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new PhantomAtom(new TeXFormula(tp, args[1], false).root, false,
				true, true);
	}
	...
	public static final Atom rotatebox_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new RotateAtom(new TeXFormula(tp, args[2]).root,
	...
	public static final Atom scalebox_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new ScaleAtom(new TeXFormula(tp, args[2]).root,
	...
	public static final Atom resizebox_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new ResizeAtom(new TeXFormula(tp, args[3]).root, args[1],
	...
	public static final Atom raisebox_macro(final TeXParser tp,
		...
		return new RaiseAtom(new TeXFormula(tp, args[2]).root, (int) raise[0],
	...
	public static final Atom fgcolor_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		try {
			return new ColorAtom(new TeXFormula(tp, args[2]).root, null,
	...
	public static final Atom fcolorbox_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new FBoxAtom(new TeXFormula(tp, args[3]).root,
	...
	public static final Atom doteq_macro(final TeXParser tp, final String[] args)
			throws ParseException {
		Atom at = new UnderOverAtom(SymbolAtom.get("equals"),
	...
	public static final Atom jlmTextit_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new JavaFontRenderingAtom(args[1], Typeface.ITALIC);
	}
	...
	public static final Atom size_macros(final TeXParser tp, final String[] args)
		...
		return new MonoScaleAtom(new TeXFormula(tp, tp.getOverArgument(), null,
				false, tp.isIgnoreWhiteSpace()).root, f);
	}

	public static final Atom jlatexmathcumsup_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new CumulativeScriptsAtom(tp.getLastAtom(), null,
				new TeXFormula(tp, args[1]).root);
	}

	public static final Atom jlatexmathcumsub_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new CumulativeScriptsAtom(tp.getLastAtom(), new TeXFormula(tp,
				args[1]).root, null);
	}

	public static final Atom dotminus_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		Atom at = new UnderOverAtom(SymbolAtom.get("minus"),
	...
	public static final Atom ratio_macro(final TeXParser tp, final String[] args)
			throws ParseException {
		Atom at = new UnderOverAtom(SymbolAtom.get("normaldot"),
	...
	public static final Atom geoprop_macro(final TeXParser tp,
		...
		Atom at = new UnderOverAtom(SymbolAtom.get("minus"), ddot,
	...
	public static final Atom minuscolon_macro(final TeXParser tp,
		...
		at.add(new UnderOverAtom(SymbolAtom.get("normaldot"), SymbolAtom
	...
	public static final Atom minuscoloncolon_macro(final TeXParser tp,
		...
		RowAtom at = new RowAtom(SymbolAtom.get("minus"));
		at.add(new SpaceAtom(TeXConstants.UNIT_EM, -0.095f, 0f, 0f));
		Atom colon = new UnderOverAtom(SymbolAtom.get("normaldot"),
				SymbolAtom.get("normaldot"), TeXConstants.UNIT_MU, 5.2f, false,
				true);
		at.add(colon);
		at.add(colon);
	...
	public static final Atom colonminus_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		RowAtom at = new RowAtom(new UnderOverAtom(SymbolAtom.get("normaldot"),
				SymbolAtom.get("normaldot"), TeXConstants.UNIT_MU, 5.2f, false,
				true));
	...
	public static final Atom hstrok_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		RowAtom ra = new RowAtom(new SpaceAtom(TeXConstants.UNIT_EX, -0.1f, 0f,
				0f));
	...
	public static final Atom Hstrok_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		RowAtom ra = new RowAtom(new SpaceAtom(TeXConstants.UNIT_EX, 0.28f, 0f,
				0f));
	...
	public static final Atom dstrok_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		RowAtom ra = new RowAtom(new SpaceAtom(TeXConstants.UNIT_EX, 0.25f, 0f,
				0f));
		ra.add(SymbolAtom.get("bar"));
		VRowAtom vra = new VRowAtom(new LapedAtom(ra, 'r'));
		vra.setRaise(TeXConstants.UNIT_EX, -0.1f);
	...
	public static final Atom T_macro(final TeXParser tp, final String[] args)
			throws ParseException {
		return new RotateAtom(new TeXFormula(tp, args[1]).root, 180,
				"origin=cc");
	}
	...
	public static final Atom textcircled_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		return new TextCircledAtom(new RomanAtom(
				new TeXFormula(tp, args[1]).root));
	}
	...
	public static final Atom sc_macro(final TeXParser tp, final String[] args)
			throws ParseException {
		return new SmallCapAtom(new TeXFormula(tp, tp.getOverArgument(), null,
				false, tp.isIgnoreWhiteSpace()).root);
	}
	...
	public static final Atom iint_macro(final TeXParser tp, final String[] args)
		...
		return new TypedAtom(TeXConstants.TYPE_BIG_OPERATOR,
	...
	public static final Atom idotsint_macro(final TeXParser tp,
		...
		cdots.add(cdotp);
		cdots.add(cdotp);
		ra.add(new TypedAtom(TeXConstants.TYPE_INNER, TeXConstants.TYPE_INNER,
				cdots));
		ra.add(new SpaceAtom(TeXConstants.UNIT_MU, -1f, 0f, 0f));
		ra.add(integral);
		ra.lookAtLastAtom = true;
	...
	public static final Atom lmoustache_macro(final TeXParser tp,
			final String[] args) throws ParseException {
		Atom at = new BigDelimiterAtom((SymbolAtom) SymbolAtom
