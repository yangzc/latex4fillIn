...
public interface TeXFont {
	 ...
	 * 
	 * @param pointSize
	 *            the new size (in points) of the derived {@link TeXFont}
	 ...
	 * @return the Char-object specifying the given character in the given text
	 *         style
	...
	public CString getString(String c, String textStyle, int style)
			throws TextStyleMappingNotFoundException;
	 ...
	 * 
	 * @param cf
	 *            CharFont-object determining a specific character of a specific
	 *            font
	 * @param style
	 *            the style in which the atom should be drawn
	...
	/**
	 * Get a Char-object for the given symbol with metric information depending
	 * on "style".
	 * 
	 * @param name
	 *            the symbol name
	...
	public CString getDefaultString(String str, int style);
	 ...
	 * 
	 * @param cf
	 *            the character and it's font above which an accent has to be
	 *            placed
	 * @param style
	 *            the render style
	 ...
	 *         buid an arbitrary large version of this character.
	 */
